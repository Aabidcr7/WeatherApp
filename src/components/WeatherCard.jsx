...
const API= "309ecd158b0b979fbe8a27e76a13df62";
...
const WeatherCard = () => {
  ...
  return (
    <div className='bg-gradient-to-r from-cyan-500 to-blue-500 mt-10 p-2 w-[400px] h-[320px] pt-4 border-2 border-solid border-indigo-500'>
